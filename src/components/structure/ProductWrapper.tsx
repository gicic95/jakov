...
export default function ProductWrapper({
  ...
  return (
    <>
      ...
      >
        <div className="sm:w-1/3 lg:w-1/6   h-fit sm:mr-4 hidden sm:flex  rounded-2xl">
          <ActionFilters
            categories={
            ...
            setProducts={() => {}}
            attributesSSR={attributesSSR as zAttributes[]}
            banners={banners || []}
            searchParams={searchParams || []}
          />
        </div>
        <div className="flex flex-col w-full mt-5 sm:mt-0  sm:w-2/3 lg:w-5/6">
          ...
          <div className="w-full bg-white rounded-2xl shadow-md  h-fit  grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5">
            {
              <>
                ...
                {banners?.find((t) => t?.position?.name.includes("drugi")) ? (
                  <div className="col-span-full my-5 px-3 -mt-5">
                    <BannerHorizontal
